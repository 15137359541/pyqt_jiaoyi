...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.right_bar_widget_search_input.setPlaceholderText('输入歌手，歌曲')
        ...
        self.recommend_button_1.setIcon(QtGui.QIcon('界面美化素材/r1.jpg'))  # 设置按钮图标
        ...
        self.recommend_button_2.setIcon(QtGui.QIcon('界面美化素材/r2.jpg'))
        ...
        self.recommend_button_3.setIcon(QtGui.QIcon('界面美化素材/r3.jpg'))
        ...
        self.recommend_button_4.setIcon(QtGui.QIcon('界面美化素材/r4.jpg'))
        ...
        self.recommend_button_5.setIcon(QtGui.QIcon('界面美化素材/r5.jpg'))
        ...
        self.playlist_button_1.setIcon(QtGui.QIcon('界面美化素材/p1.jpg'))
        ...
        self.playlist_button_2.setIcon(QtGui.QIcon('界面美化素材/p2.jpg'))
        ...
        self.playlist_button_3.setIcon(QtGui.QIcon('界面美化素材/p3.jpg'))
        ...
        self.playlist_button_4.setIcon(QtGui.QIcon('界面美化素材/p4.jpg'))
