...
class JoinQuantClient(BaseQuantClient):
    ...
    def login(self):
        ...
        self._session.get(self.BASE_URL, timeout=self._timeout,verify=False)
    ...
    def query(self):
        ...
        # print('transaction_detail is ',transaction_detail)
...
# 采用*元组、**字典的方式调用
# res = JoinQuantClient(**{'username':'15137359541','password':'123456'})
#MACD均线择时策略-模拟交易
res = JoinQuantClient(username=15137359541,password=123456,backtest_id='89752c63363154f90f2544eb4dd3835e')
#白马股策略-Clone-模拟交易
# res = JoinQuantClient(username=15137359541,password=123456,backtest_id='0a6081998b86d9f8bb4c359ebbfb2766')
res.login()
cons = res.query()
for item in cons:
    print('-'*20)
